...
//show the results
	...
	if (!isset($dashboard_chart_type) || $dashboard_chart_type == "progress_bar") {
		...
		if ($dashboard_row_span > 1) {
			...
			echo "	<div class='progress_container' style='width: 80%; height: 15px; border-radius: 10px; background: ".($settings->get('theme', 'dashboard_cpu_usage_chart_sub_color') ?? '#d4d4d4')."; overflow: hidden;'>\n";
		...
		if ($dashboard_row_span >= 1) {
			...
			echo "	<div class='progress_container' style='width: 80%; height: 15px; border-radius: 10px; background: ".($settings->get('theme', 'dashboard_disk_usage_chart_sub_color') ?? '#d4d4d4')."; overflow: hidden;'>\n";
